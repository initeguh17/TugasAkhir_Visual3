...
begin
  ...
  zqry1.SQL.Add('insert into barang values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'")');
  zqry1.ExecSQL ;
...
ShowMessage('DATA BERHASIL DIUPDATE!');
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update barang set kode_kartu="'+edt1.Text+'", nama_kartu="'+edt2.Text+'" where id="'+id+'"');
  zqry1. ExecSQL;
